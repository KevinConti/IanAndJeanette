    ...
    <nav className="bg-red-400 text-white">
      <div className="flex flex-wrap items-center justify-between max-w-4xl mx-auto p-4 pt-4 md:p-8">
        <Link to="/" className="flex items-start no-underline text-white">
          ...
          <span className="font-bold text-xl tracking-tight hover:font-extrabold hover:tracking-normal">{siteTitle}</span>
        </Link>
        ...
        >
          <div className="text-sm">
            <Link
              to="/"
              className="block mt-4 md:inline-block md:mt-0 mr-6 no-underline hover:underline text-white"
            >
              Home
            </Link>
